...
public class DWStyles : EditorWindow {
	/*
	...
	{
		if(BuildManagerWindow.visualOverhaul != true)
		{
		...
		GUILayout.Space(-5f);
		if(toggleDropDown){
			GUILayout.Label(((Texture)BuildManagerWindow.ArrowIconDown), GetLargeLabelIcon());
		}
		else
		{
			GUILayout.Label(((Texture)BuildManagerWindow.ArrowIconRight), GetLargeLabelIcon());
		}
	...
	public static bool DrawFoldout(bool toggleDropDown, string displayText = "", string toolTip = "")
	{
		...
		EditorGUILayout.BeginHorizontal();
		if(toggleDropDown){
			GUILayout.Label(((Texture)BuildManagerWindow.ArrowIconDown), GetSmallLabelIcon());
		}
		else
		{
			GUILayout.Label(((Texture)BuildManagerWindow.ArrowIconRight), GetSmallLabelIcon());
		}
		GUILayout.Space(-14);
	...
	public static bool DrawMinusButton(int size = -1)
	{
		if(BuildManagerWindow.visualOverhaul != true)
		{
			return GUILayout.Button(BuildManagerWindow.MinusIcon, GUILayout.ExpandWidth(false));
		}
		if(size > 0)
		{
			...
			return GUILayout.Button(BuildManagerWindow.MinusIcon, tallerToolbar, GUILayout.ExpandWidth(false));
		}
		return GUILayout.Button(BuildManagerWindow.MinusIcon, EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
	}
	...
	public static bool DrawArrowButton()
	{
		if(BuildManagerWindow.visualOverhaul != true)
		{
			return GUILayout.Button(BuildManagerWindow.ArrowIcon, GUILayout.ExpandWidth(false));
		}
		return GUILayout.Button(BuildManagerWindow.ArrowIcon, EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
	}
	...
	public static bool DrawPlusButton()
	{
		if(BuildManagerWindow.visualOverhaul != true)
		{
			return GUILayout.Button(BuildManagerWindow.PlusIcon, GUILayout.ExpandWidth(false));
		}
		return GUILayout.Button(BuildManagerWindow.PlusIcon, EditorStyles.toolbarButton, GUILayout.ExpandWidth(false));
	}
	
	public static void DrawLabel(string labelText, float minWidth = 105)
	{
		GUILayout.Label(labelText, DWStyles.GetSubTitleLabel(), GUILayout.ExpandWidth(false), GUILayout.MinWidth(105));
	}
	...
	{
		GUILayout.Label(labelText, DWStyles.GetSubTitleLabel(offset), GUILayout.ExpandWidth(false), GUILayout.MinWidth(105));
	}
	...
	public static bool DrawToggle(bool value, params GUILayoutOption[] options)
	{
		...
		if(value){
			GUILayout.Label(((Texture)BuildManagerWindow.toggleActiveIcon), label, GUILayout.Width(16));
		}
		else
		{
			GUILayout.Label(((Texture)BuildManagerWindow.toggleInactiveIcon), label, GUILayout.Width(16));
		}
		EditorGUILayout.EndVertical();
