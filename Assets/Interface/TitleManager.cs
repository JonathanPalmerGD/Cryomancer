...
public class TitleManager : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		if (menuState == 0)
		{
			...
			GUI.Label(new Rect(Screen.width / 2 - Screen.width * .3f, Screen.height * .05f, Screen.width * .6f, Screen.height * .3f), "Cryomancer");
